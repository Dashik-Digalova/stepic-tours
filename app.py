...
@app.route('/')
def main():
    output = render_template('index.html', tours=tours, description=description, subtitle=subtitle, title=title, departures=departures)
    return output
...
def show_tour(tour_id):
    ...
    output = render_template('tour.html', tour=tour, tour_id=tour_id, tours=tours, departures=departures)
    return output
